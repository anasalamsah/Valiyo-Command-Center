...
import { askValiyoAI, diagnoseProductAI } from './server/services/gemini.js';
import {
...
async function startServer() {
  ...
  app.listen(PORT, '0.0.0.0', () => {
    console.log(`Valiyo OS Server running on http://0.0.0.0:${PORT}`);
  });
}
