                    ...
                    <td className="py-3 px-4 font-sans font-medium text-slate-100">
                      ...
                      {item.scheduledPaymentDate && (
                        <div className="text-[10px] font-mono mt-0.5 flex items-center gap-1">
                          ...
                          <span className="text-amber-300">Jadwal Transfer: {item.scheduledPaymentDate}</span>
                          {item.payoutStatus === 'PAID' ? (
                            <span className="text-emerald-400 font-bold ml-1">• LUNAS</span>
                          ) : (
                            <span className="text-amber-400 font-semibold ml-1">• TERJADWAL</span>
                          )}
                        </div>
                      )}
                      {item.notes && (
